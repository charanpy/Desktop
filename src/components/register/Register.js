...
class Register extends React.Component{
	...
	render(){
		...
		return(
			...
			<div className="">
			<input className="center b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Sign in" onClick={this.onSubmitSignIn} loadUser={this.loadUser} />
			</div>
